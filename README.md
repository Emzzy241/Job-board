...
#### A Job Board application made with ASP.NET6.0
...
## Description
_A job posting board where a user can create instances of a JobOpening class representing local positions._
